...
static const _Direction_type_support_symbol_names_t _Direction_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, direction_interfaces, msg, Direction)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, direction_interfaces, msg, Direction)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, direction_interfaces, msg, Direction)() {
  return &::direction_interfaces::msg::rosidl_typesupport_c::Direction_message_type_support_handle;
}
